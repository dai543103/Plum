#ifndef __PLUM_DEFINE_H__
#define __PLUM_DEFINE_H__
...
enum class EPlumSocketFlag
{
    EPSF_ListeningForExternalClient = (unsigned int)0x00000001,
    EPSF_ListeningForInternalServer = (unsigned int)0x00000002,
    EPSF_ConnectedByExternalClient = (unsigned int)0x00000010,
    EPSF_ConnectedByInternalServer = (unsigned int)0x00000020,
};
...
struct TExternalClientSocket
{
	...
	EPlumSocketFlag m_emSocketFlag; //socket类型
	...
	// Socket链表
	TExternalClientSocket* m_pPrevSocket;
	TExternalClientSocket* m_pNextSocket;
};

struct TInternalServerSocket
{
    //主机序
    int m_iSocketFD;
