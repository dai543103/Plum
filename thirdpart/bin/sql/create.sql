...
CREATE TABLE `tbl_userinfo` (
  ...
  `roleid` int(11) DEFAULT '0' COMMENT '当前角色id',
  `rank` int(11) DEFAULT '0' COMMENT '军衔',
  `golds` int(11) DEFAULT '0' COMMENT '金币',
  `exp` int(11) DEFAULT '0' COMMENT '经验',
  `level` int(11) unsigned DEFAULT '0' COMMENT '等级',
  `logintype` tinyint DEFAULT '0' COMMENT '玩家登陆类型',
  `weapons` blob , 
  `skills` blob,
  `progress` blob,
  `missions` blob,
