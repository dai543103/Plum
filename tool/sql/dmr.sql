...
--
-- Host: localhost    Database: dmr_215
-- ------------------------------------------------------
...
CREATE TABLE `tb_aura` (
  ...
  `support_value` double NOT NULL DEFAULT '0' COMMENT 'support值',
...
CREATE TABLE `tb_database_version` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COMMENT='版本表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_nei_gong`
--

DROP TABLE IF EXISTS `tb_nei_gong`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_nei_gong` (
  `charguid` bigint(20) NOT NULL DEFAULT '0',
  `Id` int(11) NOT NULL DEFAULT '0' COMMENT '内功ID（经脉ID,有分组信息）',
  `NodeID` int(11) NOT NULL DEFAULT '0' COMMENT '最后冲穴成功的穴位ID',
  `NodeLevel` int(11) NOT NULL DEFAULT '0' COMMENT '穴位当前的等级',
  PRIMARY KEY (`Id`,`charguid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='内功（经脉）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_player_beauty`
--

DROP TABLE IF EXISTS `tb_player_beauty`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_beauty` (
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '挑战玩家guid',
  `beauty_id` int(11) NOT NULL DEFAULT '0' COMMENT '美人ID',
  `cur_cnt` int(11) NOT NULL DEFAULT '0' COMMENT '今日次数',
  `total_cnt` int(11) NOT NULL DEFAULT '0' COMMENT '总次数',
  PRIMARY KEY (`charguid`,`beauty_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='美人表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_player_book`
--

DROP TABLE IF EXISTS `tb_player_book`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_book` (
  `charguid` bigint(20) NOT NULL COMMENT '角色GUID',
  `id` int(11) NOT NULL COMMENT '经书ID',
  `state` int(4) DEFAULT '0' COMMENT '经书状态 1未开启 2已开启',
  `level` int(11) DEFAULT '0' COMMENT '经书的等级',
  `exp` int(11) DEFAULT '0' COMMENT '经书的经验',
  PRIMARY KEY (`charguid`,`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='四书五经表（深造）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_player_extra` (
  ...
  `actcode_flags` varchar(256) NOT NULL DEFAULT '' COMMENT '激活码标识',
  ...
  `magickey_tili` double NOT NULL DEFAULT '0' COMMENT '法宝体力',
  `crystal_minetask` int(11) NOT NULL DEFAULT '0' COMMENT '水晶副本任务',
  `zhanyinlv` int(11) NOT NULL DEFAULT '0' COMMENT '战印层数',
  PRIMARY KEY (`charguid`)
...
--
-- Table structure for table `tb_player_glory_level`
--

DROP TABLE IF EXISTS `tb_player_glory_level`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_glory_level` (
  `charguid` bigint(11) NOT NULL COMMENT '角色GUID',
  `glory_id` int(11) NOT NULL COMMENT '荣耀ID',
  `point` int(11) NOT NULL DEFAULT '0' COMMENT '荣耀点数',
  PRIMARY KEY (`charguid`,`glory_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='玩家荣耀等级表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_player_info` (
  ...
  `canjuan` int(11) NOT NULL DEFAULT '0' COMMENT '残卷',
  `exts` varchar(128) NOT NULL DEFAULT '' COMMENT 'exts',
  `account_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '帐号GUID' ,
  `create_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建角色时间',
  `last_logout` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上次登出时间',
  `last_login` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '上次登录时间',
  `last_mac` varchar(32) NOT NULL DEFAULT '' COMMENT '上次登录Mac' ,
  `last_ip` varchar(32) NOT NULL DEFAULT '' COMMENT '上次登录IP地址',
...
--
-- Table structure for table `tb_player_magickeys`
--

DROP TABLE IF EXISTS `tb_player_magickeys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_magickeys` (
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '角色GUID',
  `item_id` bigint(20) NOT NULL COMMENT '物品GUID',
  `item_tid` int(11) NOT NULL DEFAULT '0' COMMENT '物品配表ID',
  `slot_id` int(11) NOT NULL DEFAULT '0' COMMENT '位置',
  ...
  `wuxing` int(11) NOT NULL DEFAULT '0',
  `totalexp` bigint(20) NOT NULL DEFAULT '0',
  `time_stamp` bigint(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`item_id`),
  KEY `charguid` (`charguid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='玩家法宝表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_player_secret_dupl`
--

DROP TABLE IF EXISTS `tb_player_secret_dupl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_secret_dupl` (
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '角色GUID',
  `state` int(11) NOT NULL DEFAULT '0',
  `commaxid` int(11) NOT NULL DEFAULT '0',
  `tili` int(11) NOT NULL DEFAULT '0',
  `counts` int(11) NOT NULL DEFAULT '0',
  `buy_tili_counts` int(11) NOT NULL DEFAULT '0',
  `buy_enter_counts` int(11) NOT NULL DEFAULT '0',
  `comtime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`charguid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秘境副本表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `tb_player_secret_dupl_suit`
--

DROP TABLE IF EXISTS `tb_player_secret_dupl_suit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_secret_dupl_suit` (
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '角色GUID',
  `suit` bigint(20) NOT NULL DEFAULT '0',
  `equips` varchar(256) NOT NULL DEFAULT '',
  `time_stamp` bigint(20) NOT NULL DEFAULT '0',
  PRIMARY KEY (`charguid`,`suit`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秘境副本套装表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_player_shenbing` (
  ...
  `uplevel_num` int(11) NOT NULL DEFAULT '0' COMMENT '今日升阶次数',
  PRIMARY KEY (`charguid`)
...
--
-- Table structure for table `tb_player_wing_dupl`
--

DROP TABLE IF EXISTS `tb_player_wing_dupl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_player_wing_dupl` (
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '角色GUID',
  `enter_counts` int(11) NOT NULL DEFAULT '0',
  `extra_enter` int(11) NOT NULL DEFAULT '0',
  `allkill_count` int(11) NOT NULL DEFAULT '0',
  `atk` int(11) NOT NULL DEFAULT '0',
  `time_limit` int(11) NOT NULL DEFAULT '0',
  `remain_sec` int(11) NOT NULL DEFAULT '0',
  `wave` int(11) NOT NULL DEFAULT '0',
  `monster1` int(11) NOT NULL DEFAULT '0',
  `monster2` int(11) NOT NULL DEFAULT '0',
  `monster3` int(11) NOT NULL DEFAULT '0',
  `monster4` int(11) NOT NULL DEFAULT '0',
  `gamemapid` bigint(20) NOT NULL DEFAULT '0',
  `line` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`charguid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='翅膀副本表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_rank_secret_simple`
--

DROP TABLE IF EXISTS `tb_rank_secret_simple`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_rank_secret_simple` (
  `rank` int(11) NOT NULL COMMENT '排行',
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '角色GUID',
  `lastrank` int(11) NOT NULL DEFAULT '0' COMMENT '上次排行',
  ...
  PRIMARY KEY (`rank`),
  KEY `guid_idx` (`charguid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='单人秘境排行';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tb_rank_wing`
--

DROP TABLE IF EXISTS `tb_rank_wing`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tb_rank_wing` (
  `rank` int(11) NOT NULL COMMENT '排行',
  `charguid` bigint(20) NOT NULL DEFAULT '0' COMMENT '角色GUID',
  `lastrank` int(11) NOT NULL DEFAULT '0' COMMENT '上次排行',
  `rankvalue` bigint(20) NOT NULL DEFAULT '0' COMMENT '神兵等级',
  PRIMARY KEY (`rank`),
  KEY `guid_idx` (`charguid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='翅膀排行';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'dmr_215'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_account_adult_update`(IN `in_account_id` bigint,  IN `in_adult` int)
BEGIN
	UPDATE tb_account SET  adult = in_adult	WHERE account_id=in_account_id;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_account_create`(IN `in_account` varchar(64), IN `in_accountid` bigint, IN `in_groupid` int, IN `in_guid` bigint, IN `in_timestamp` bigint, IN `in_ip` varchar(32), IN `in_mac` varchar(32))
BEGIN
	INSERT INTO tb_account(account, account_id, groupid, charguid, create_time, last_login, last_logout, last_ip, last_mac)
	VALUES(in_account, in_accountid, in_groupid, in_guid, FROM_UNIXTIME(in_timestamp), FROM_UNIXTIME(in_timestamp), FROM_UNIXTIME(in_timestamp), in_ip, in_mac);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT account, account_id ,groupid, charguid, valid, forb_chat_time, forb_chat_last, forb_acc_time, forb_acc_last, UNIX_TIMESTAMP(last_logout) as last_logout, UNIX_TIMESTAMP(last_login) as last_login, UNIX_TIMESTAMP(create_time) as create_time 
...
BEGIN
	SELECT account, groupid, tb_player_info.charguid, valid, tb_account.forb_chat_time, tb_account.forb_chat_last, tb_account.forb_acc_time, tb_account.forb_acc_last, adult,
		 UNIX_TIMESTAMP(tb_account.last_logout) as last_logout, UNIX_TIMESTAMP(tb_account.last_login) as last_login, UNIX_TIMESTAMP(tb_account.create_time) as create_time,
		 gm_flag, welfare, tb_account.forb_type, tb_account.lock_reason 
	FROM tb_account INNER JOIN tb_player_info ON tb_account.account_id = tb_player_info.account_id WHERE in_charguid = tb_player_info.charguid ;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT charguid, last_logout, create_time, valid, account_id FROM tb_account
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_delete_magickey_by_id_and_timestamp` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_delete_magickey_by_id_and_timestamp`(IN `in_charguid` bigint, IN `in_time_stamp` bigint)
BEGIN
  DELETE FROM `tb_player_magickeys` where charguid = in_charguid AND time_stamp <> in_time_stamp;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT *, (0) AS last_time FROM tb_forb_mac 
	left join tb_player_info
	on tb_forb_mac.charguid = tb_player_info.charguid	
...
BEGIN
	SELECT P.*, A.account, M.* 
	FROM tb_account AS A, tb_player_info AS P, tb_player_map_info AS M
	WHERE (P.charguid = in_guid AND A.account_id = P.account_id AND M.charguid = in_guid);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
, IN `in_skill7` int, IN `in_skill8` int, IN `in_skill9` int, IN `in_skill10` int)
BEGIN
	...
	in_skill7, in_skill8, in_skill9, in_skill10)
	...
	skill7=in_skill7, skill8=in_skill8, skill9=in_skill9, skill10=in_skill10;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_insert_update_lingshoumudi`(IN `in_charguid` bigint,IN `in_FinishLayer` int,
IN `in_MyMaxLayer` int, IN `in_ResetNum` int)
BEGIN
	INSERT INTO tb_lingshoumudi(charguid, FinishLayer, MyMaxLayer, ResetNum)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_insert_update_nei_gong` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_insert_update_nei_gong`(IN in_charguid bigint, IN in_id int, IN in_NodeID int, IN in_NodeLevel int)
BEGIN
	INSERT INTO `tb_nei_gong` (`charguid`, `Id`, `NodeID`, `NodeLevel`) 
    VALUES (in_charguid, in_id, in_NodeID, in_NodeLevel)
    ON DUPLICATE KEY UPDATE charguid=in_charguid, Id=in_Id,
	NodeID = in_NodeID,	NodeLevel = in_NodeLevel;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
IN `in_attrdan` int, IN `in_proce_num` int, IN `in_total_proce` int, IN `in_fh_zhenqi` bigint, IN `in_consum_zhenqi` bigint, IN `in_uplevel_num` bigint)
BEGIN
...
BEGIN
	select *, (select count(*) from tb_account, tb_player_info where tb_account.account_id=tb_player_info.account_id and TO_DAYS(create_time) = TO_DAYS(in_date)) as c
from tb_account, tb_player_info where tb_account.account_id=tb_player_info.account_id and TO_DAYS(create_time) = TO_DAYS(in_date) limit in_begin,in_num;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	select *, (select count(*) from tb_account, tb_player_info where tb_account.account_id=tb_player_info.account_id and TO_DAYS(last_login) = TO_DAYS(in_date)) as c
from tb_account, tb_player_info where tb_account.account_id=tb_player_info.account_id and TO_DAYS(last_login) = TO_DAYS(in_date) limit in_begin,in_num;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_platform_select_role_info`(IN `in_account` VARCHAR(32))
BEGIN
	SELECT * FROM tb_player_info left join tb_account
	on tb_player_info.account_id = tb_account.account_id
	left join tb_player_map_info
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_platform_select_role_little_info`(IN `in_account` VARCHAR(32))
BEGIN
	SELECT * FROM tb_player_info left join tb_account
	on tb_player_info.account_id = tb_account.account_id
	left join tb_player_map_info
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_binghun_insert_update`(IN `in_charguid` bigint, IN `in_id` int, IN `in_state` int, IN `in_current` int,IN `in_activetime` bigint,IN `in_time_stamp` bigint)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_book_insert_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_book_insert_update`(IN `in_gid` bigint,  IN `in_id` int,IN `in_state` int,IN `in_level` int,IN `in_exp` int)
BEGIN
	INSERT INTO tb_player_book(charguid, id, state, level, exp)
	VALUES (in_gid, in_id, in_state, in_level,in_exp) 
	ON DUPLICATE KEY UPDATE charguid=in_gid, id=in_id,level=in_level, state=in_state, exp=in_exp;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_book_select` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_book_select`(IN `in_charguid` bigint)
BEGIN
	SELECT * FROM tb_player_book WHERE charguid = in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_create_role_insert_update`(IN `in_id` bigint,  IN `in_name` varchar(32), IN `in_level` int, IN `in_prof` int, IN `in_icon` int, IN `in_sex` int, 
		IN `in_bindgold` int, IN `in_zhenqi` int, IN `in_mp` int, IN `in_hp` int, IN `in_power` int, IN `in_exts` varchar(128), IN `in_account_id` bigint, IN `timestamp` bigint)
BEGIN
	INSERT INTO tb_player_info(charguid, name, level, prof, iconid, sex, bindgold, zhenqi, mp, hp, power, exts ,account_id ,create_time)
	VALUES (in_id, in_name, in_level, in_prof, in_icon, in_sex, in_bindgold, in_zhenqi, in_mp, in_hp, in_power, in_exts ,in_account_id ,FROM_UNIXTIME(timestamp)) 
	ON DUPLICATE KEY UPDATE charguid=in_id, name=in_name, level=in_level, prof = in_prof, iconid = in_icon, sex = in_sex, 
		bindgold=in_bindgold, zhenqi=in_zhenqi, mp=in_mp, hp=in_hp, power=in_power, exts = in_exts, account_id=in_account_id, create_time=FROM_UNIXTIME(timestamp);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_extra_insert_update`(IN `in_uid` bigint,  IN `in_func_flags` varchar(128), IN `in_expend_bag` int, IN `in_bag_online` int, IN `in_expend_storage` int, 
		...
		IN `in_magickey_tili` double, IN `in_crystal_minetask` int, IN `in_zhanyinlv` int)
BEGIN
	INSERT INTO tb_player_extra(charguid, func_flags, expend_bag, bag_online, expend_storage, 
		...
		magickey_tili, crystal_minetask, zhanyinlv)
	VALUES (in_uid, in_func_flags, in_expend_bag, in_bag_online, in_expend_storage, 
		...
		in_magickey_tili, in_crystal_minetask, in_zhanyinlv) 
	ON DUPLICATE KEY UPDATE charguid=in_uid, func_flags=in_func_flags, expend_bag=in_expend_bag,
		...
		magickey_tili = in_magickey_tili, crystal_minetask = in_crystal_minetask, zhanyinlv = in_zhanyinlv;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_glory_insert_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_glory_insert_update`(IN `in_charguid` bigint, IN `in_glory_id` int, IN `in_point` int)
BEGIN
  INSERT INTO tb_player_glory_level(charguid, glory_id, point)
  VALUES (in_charguid, in_glory_id, in_point) 
  ON DUPLICATE KEY UPDATE charguid=in_charguid, glory_id=in_glory_id, point=in_point;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_glory_select_by_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_glory_select_by_id`(IN `in_charguid` bigint)
BEGIN
  SELECT * FROM tb_player_glory_level WHERE charguid=in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_info_insert_update`(IN `in_id` bigint,  IN `in_name` varchar(32), IN `in_level` int, IN `in_exp` bigint, IN `in_vip_level` int, IN `in_vip_exp` int,
				...
				IN `in_pvplevel` int, IN `in_sheild` bigint, IN `in_glorylevel` int, IN `in_gloryexp` int, IN `in_canjuan` int )
BEGIN
	INSERT INTO tb_player_info(charguid, name, level, exp, vip_level, vip_exp,
								...
								blesstime2, blesstime3, suitflag, crossscore, crossexploit, crossseasonid, pvplevel, sheild, glorylevel, gloryexp,canjuan)
	VALUES (in_id, in_name, in_level, in_exp, in_vip_level, in_vip_exp,
			...
			in_blesstime2, in_blesstime3, in_suitflag, in_crossscore, in_crossexploit, in_crossseasonid, in_pvplevel, in_sheild, in_glorylevel, in_gloryexp, in_canjuan) 
	ON DUPLICATE KEY UPDATE name=in_name, level=in_level, exp = in_exp, vip_level = in_vip_level, vip_exp = in_vip_exp,
		...
		crossseasonid = in_crossseasonid, pvplevel = in_pvplevel, sheild = in_sheild, glorylevel = in_glorylevel, gloryexp = in_gloryexp, canjuan = in_canjuan;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT name, exts, prof, iconid, sex, level, exp, power, vip_level, vip_exp, hp, mp, hunli,
	tipo, shenfa, jingshen, leftpoint, totalpoint, sp, max_sp, sp_recover, bindgold, unbindgold, 
	bindmoney, unbindmoney, zhenqi, soul, yao_hun, head, suit, weapon, killtask_count, drop_val,
	drop_lv, honor, lingzhi, equipval, extremityval, jingjie_exp, wuhunid, shenbingid, online_time,
	onlinetime_day, hearthstone_time, blesstime, blesstime2, blesstime3, suitflag, crossscore, crossexploit,
	crossseasonid, pvplevel, glorylevel, gloryexp, sheild, CuMoJiFen, slayerQuestNum, magickey, datangcnt, 
	luck_point, changeproftag, talent_point, pk_mode, pk_status, pk_flags, pk_evil, redname_time, grayname_time, pk_count,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_items_insert_update`(IN `in_charguid` bigint, IN `in_item_id` bigint, IN `in_item_tid` int, 
IN `in_slot_id` int, IN `in_stack_num` int, IN `in_flags` bigint, IN `in_bag` int ,IN `in_time_stamp` bigint,
IN `in_param1` int, IN `in_param2` int, IN `in_param3` int)
BEGIN
	...
	param2 = in_param2, param3 = in_param3;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_magickey_insert_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_magickey_insert_update`(IN `in_charguid` bigint, IN `in_item_id` bigint, IN `in_item_tid` int, IN `in_slot_id` int, 
	IN `in_stack_num` int, IN `in_flags` bigint, IN `in_bag` int, IN `in_level` int, IN `in_wuxing` int, IN `in_totalexp` bigint,
	IN `in_time_stamp` bigint)
BEGIN
	INSERT INTO tb_player_magickeys(charguid, item_id, item_tid, slot_id, stack_num, flags, bag,
		level, wuxing, totalexp, time_stamp)
	VALUES (in_charguid, in_item_id, in_item_tid, in_slot_id, in_stack_num, in_flags, in_bag,
		in_level, in_wuxing, in_totalexp, in_time_stamp) 
	ON DUPLICATE KEY UPDATE  item_id = in_item_id, item_tid = in_item_tid, slot_id = in_slot_id, stack_num = in_stack_num,
	flags = in_flags, bag = in_bag, level = in_level, wuxing = in_wuxing, totalexp = in_totalexp, time_stamp = in_time_stamp;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_magickey_select_by_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_magickey_select_by_id`(IN `in_charguid` bigint)
BEGIN
	SELECT * FROM tb_player_magickeys WHERE charguid = in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_secret_delete_by_id_and_timestamp` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_secret_delete_by_id_and_timestamp`(IN `in_charguid` bigint, IN `in_time_stamp` bigint)
BEGIN
  DELETE FROM `tb_player_secret_dupl_suit` where charguid = in_charguid AND time_stamp <> in_time_stamp;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_player_secret_suit_insert_update` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_secret_suit_insert_update`(IN `in_charguid` bigint, IN `in_suit` int, IN `in_equips` varchar(256), IN `in_time_stamp` bigint)
BEGIN
	INSERT INTO tb_player_secret_dupl_suit(charguid, suit, equips, time_stamp)
	VALUES (in_charguid, in_suit, in_equips,in_time_stamp)
	ON DUPLICATE KEY UPDATE  suit = in_suit, equips = in_equips, time_stamp = in_time_stamp;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
, IN `in_proficiencylvl` int, IN `in_procenum` int, IN `in_skinlevel` int, IN `in_attr_num` int, IN `in_uplevel_num` int)
BEGIN
  ...
  , procenum=in_procenum,skinlevel = in_skinlevel,attr_num = in_attr_num, uplevel_num = in_uplevel_num;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_player_update_zhenbaoge`(IN `in_charguid` bigint, IN `in_zhenbao_id` int, IN `in_submit_once_num` int,IN `in_submit_times` int, IN `in_submit_num` int, IN `in_special_item_num1` int, IN `in_special_item_num2` int, IN `in_special_item_num3` int)
BEGIN
	INSERT INTO tb_zhenbaoge(charguid, zhenbao_id, submit_once_num, submit_times, submit_num, item_num1, item_num2, item_num3)
	VALUES (in_charguid, in_zhenbao_id, in_submit_once_num, in_submit_times, in_submit_num, in_special_item_num1, in_special_item_num2, in_special_item_num3)
	ON DUPLICATE KEY UPDATE charguid = in_charguid,zhenbao_id = in_zhenbao_id, submit_once_num=in_submit_once_num, submit_times = in_submit_times, submit_num = in_submit_num, item_num1 = in_special_item_num1, item_num2 = in_special_item_num2, item_num3 = in_special_item_num3;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_rank_secret_simple` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_rank_secret_simple`()
BEGIN
	SELECT tb_player_secret_dupl.charguid AS uid, tb_player_secret_dupl.commaxid AS rankvalue FROM tb_player_secret_dupl left join tb_player_info
	on tb_player_secret_dupl.charguid = tb_player_info.charguid
	WHERE tb_player_secret_dupl.commaxid > 0 ORDER BY tb_player_secret_dupl.commaxid DESC, tb_player_secret_dupl.comtime ASC, tb_player_info.power DESC LIMIT 100;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_rank_wing` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_rank_wing`()
BEGIN
	SELECT charguid AS uid, wingid AS rankvalue FROM tb_player_info 
	WHERE wingid > 0 ORDER BY wingid DESC, power DESC LIMIT 100;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
  SELECT * FROM tb_relation WHERE charguid=in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT item_tid as gemid, slot_id as level from tb_player_items where charguid = in_charguid and bag = 7;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT tb_account.gm_flag, tb_account.account_id, tb_account.account, tb_player_info.name    
	FROM tb_account, tb_player_info  
	WHERE tb_account.gm_flag > 0 AND tb_player_info.account_id = tb_account.account_id;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_mail_info_by_id`(IN `in_charguid` bigint)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_merge_info` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_merge_info`()
BEGIN
	SELECT * FROM tb_merge;
END */;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_nei_gong` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_nei_gong`(IN in_charguid bigint)
BEGIN
	select * from tb_nei_gong where charguid=in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_player_beauty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_player_beauty`(IN in_guid bigint)
BEGIN
	SELECT * FROM tb_player_beauty WHERE charguid = in_guid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_player_info_by_ls`(IN `in_account_id` bigint)
BEGIN
	SELECT name, level, prof, iconid, power, vip_level, head, suit, weapon, wingid, suitflag, exts, forb_type, forb_acc_time, forb_acc_last, charguid 
	FROM tb_player_info 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_rank_secret_simple` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_rank_secret_simple`()
BEGIN
	SELECT * FROM tb_rank_secret_simple;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_rank_wing` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_rank_wing`()
BEGIN
	SELECT * FROM tb_rank_wing;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT last_mac FROM tb_player_info WHERE charguid = in_guid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_secret_dupl` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_secret_dupl`(IN `in_charguid` bigint)
BEGIN
  SELECT * FROM `tb_player_secret_dupl` where charguid = in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_secret_dupl_suit` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_secret_dupl_suit`(IN `in_charguid` bigint)
BEGIN
  SELECT * FROM `tb_player_secret_dupl_suit` where charguid = in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	UNIX_TIMESTAMP(last_logout) as last_logout, tb_account.account, vip_level, vplan, wuhunid, shenbingid, wingid, suitflag from tb_player_info 
	left join tb_account
	on tb_player_info.account_id = tb_account.account_id
	where tb_player_info.charguid = in_guid;
END */;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_select_wing_dupl` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_select_wing_dupl`(IN `in_charguid` bigint)
BEGIN
  SELECT * FROM `tb_player_wing_dupl` where charguid = in_charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT P.forb_type, P.forb_acc_time, P.forb_acc_last, P.forb_chat_time, P.forb_chat_last, P.create_time, P.lock_reason, P.last_logout, P.charguid,P.level,P.name,P.prof,P.blesstime, M.base_map,M.game_map,P.blesstime2,P.blesstime3
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_aura`(IN `in_charguid` bigint, IN `in_aura_gid` bigint, IN `in_aura_id` bigint, IN `in_cast_id` bigint, 
	IN `in_end_time` bigint, IN `in_flags` int, IN `in_support_value` double)
BEGIN
	INSERT INTO tb_aura(charguid, aura_gid, aura_id, cast_id, end_time, flags, support_value)
	VALUES (in_charguid, in_aura_gid, in_aura_id, in_cast_id, in_end_time, in_flags, in_support_value) 
	ON DUPLICATE KEY UPDATE  aura_id = in_aura_id, cast_id = in_cast_id, end_time = in_end_time, flags = in_flags,
	support_value = in_support_value;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	WHERE tb_account.account_id = (select account_id from tb_player_info where tb_player_info.charguid = in_charguid);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_forbidden_acc_by_acc`(IN `in_account` VARCHAR(32), IN `in_forb_acc_last` int, IN `in_forb_acc_time` int)
BEGIN
	UPDATE tb_account SET  forb_acc_last = in_forb_acc_last, forb_acc_time = in_forb_acc_time
	WHERE account = in_account;
END */;;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_forbidden_chat`(IN  `in_acount_id`  bigint(20), IN `in_forb_chat_last` int, IN `in_forb_chat_time` int)
BEGIN
	UPDATE tb_account SET  forb_chat_last = in_forb_chat_last, forb_chat_time = in_forb_chat_time
	WHERE account_id = in_acount_id;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_forbidden_chat_by_acc`(IN `in_account` VARCHAR(32), IN `in_forb_chat_last` int, IN `in_forb_chat_time` int)
BEGIN
	UPDATE tb_account SET  forb_chat_last = in_forb_chat_last, forb_chat_time = in_forb_chat_time
	WHERE account = in_account;
END */;;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_gm_account`(IN `in_account_id` bigint, IN `in_gm` int)
BEGIN
	UPDATE tb_account SET gm_flag = in_gm WHERE account_id = in_account_id;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	WHERE account_id = (select account_id from tb_player_info where tb_player_info.charguid = in_guid);
	UPDATE tb_player_info
	SET last_mac = in_mac, last_login=FROM_UNIXTIME(in_timestamp)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_player_beauty` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_player_beauty`(IN `in_charguid` bigint,IN `in_beauty` int,
		IN `in_cur` int, IN `in_total` int)
BEGIN
	INSERT INTO tb_player_beauty(charguid, beauty_id, cur_cnt, total_cnt)
	VALUES (in_charguid, in_beauty, in_cur, in_total) 
	ON DUPLICATE KEY UPDATE charguid=in_charguid, beauty_id=in_beauty,cur_cnt = in_cur,total_cnt = in_total;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	UPDATE tb_account SET last_logout = FROM_UNIXTIME(in_timestamp) WHERE account_id=(select account_id from tb_player_info where in_guid = tb_player_info.charguid );
	UPDATE tb_player_info SET last_logout = FROM_UNIXTIME(in_timestamp) WHERE in_guid = charguid;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_rank_secret_simple` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_rank_secret_simple`(IN `in_rank` int, IN `in_charguid` bigint, IN `in_lastrank` int, IN `in_rankvalue` bigint)
BEGIN
	INSERT INTO tb_rank_secret_simple(rank, charguid, lastrank, rankvalue)
	VALUES (in_rank, in_charguid, in_lastrank, in_rankvalue)
	ON DUPLICATE KEY UPDATE rank = in_rank, charguid = in_charguid, lastrank = in_lastrank, rankvalue = in_rankvalue;
END */;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_rank_wing` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_rank_wing`(IN `in_rank` int, IN `in_charguid` bigint, IN `in_lastrank` int, IN `in_rankvalue` bigint)
BEGIN
	INSERT INTO tb_rank_wing(rank, charguid, lastrank, rankvalue)
	VALUES (in_rank, in_charguid, in_lastrank, in_rankvalue)
	ON DUPLICATE KEY UPDATE rank = in_rank, charguid = in_charguid, lastrank = in_lastrank, rankvalue = in_rankvalue;
END */;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_secret_dupl` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_secret_dupl`(IN `in_charguid` bigint, IN `in_state` int, IN `in_commaxid` int, IN `in_tili` int, 
	IN `in_counts` int, IN `in_buy_tili_counts` int, IN `in_buy_enter_counts` int, IN `in_comtime` int)
BEGIN
	INSERT INTO tb_player_secret_dupl(charguid, state, commaxid, tili, counts, buy_tili_counts, buy_enter_counts,comtime)
	VALUES (in_charguid, in_state, in_commaxid, in_tili, in_counts, in_buy_tili_counts, in_buy_enter_counts,in_comtime)
	ON DUPLICATE KEY UPDATE  state = in_state, commaxid = in_commaxid, tili = in_tili, counts = in_counts,
	buy_tili_counts = in_buy_tili_counts, buy_enter_counts = in_buy_enter_counts, comtime = in_comtime;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	WHERE account_id=(select account_id from tb_player_info where tb_player_info.charguid = in_charguid);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_wing_dupl` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_wing_dupl`(IN `in_charguid` bigint, IN `in_enter_counts` int, IN `in_extra_enter` int, IN `in_allkill_count` int, IN `in_atk` int, 
	IN `in_time_limit` int, IN `in_remain_sec` int, IN `in_wave` int, IN `in_monster1` int, IN `in_monster2` int, IN `in_monster3` bigint, IN `in_monster4` int,
	IN `in_gamemapid` bigint,IN `in_line` int)
BEGIN
	INSERT INTO tb_player_wing_dupl(charguid, enter_counts, extra_enter, allkill_count, atk, time_limit, remain_sec, wave,
		monster1, monster2, monster3, monster4, gamemapid, line)
	VALUES (in_charguid, in_enter_counts, in_extra_enter, in_allkill_count, in_atk, in_time_limit, in_remain_sec, in_wave,
		in_monster1, in_monster2, in_monster3, in_monster4, in_gamemapid, in_line) 
	ON DUPLICATE KEY UPDATE  enter_counts = in_enter_counts, extra_enter = in_extra_enter, allkill_count = in_allkill_count, atk = in_atk, time_limit = in_time_limit,
	remain_sec = in_remain_sec, wave = in_wave, monster1 = in_monster1, monster2 = in_monster2, monster3 = in_monster3, monster4 = in_monster4,
	gamemapid = in_gamemapid, line = in_line;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `sp_update_ws_offlogic`(IN `in_aid` bigint, IN `in_charguid` bigint, IN `in_type` int, IN `in_param_b1` bigint, IN `in_param_b2` bigint, IN `in_param1` int, IN `in_param2` int, IN `in_param_str` varchar(32))
BEGIN
	INSERT INTO tb_ws_offline_logic(aid, charguid, type, param_b1, param_b2, param1, param2, param_str)
	VALUES (in_aid, in_charguid, in_type, in_param_b1, in_param_b2, in_param1, in_param2, in_param_str) 
	ON DUPLICATE KEY UPDATE charguid=in_charguid, type=in_type, param_b1=in_param_b1, param_b2=in_param_b2, param1=in_param1, param2=in_param2, param_str = in_param_str;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2016-07-13 14:05:18
