...
{
    if( pstrDecode == nullptr || *pstrDecode == nullptr || pucDest == nullptr)
    {
        return 0;
    }
...
int DecodeShort16( char **pstrDecode, unsigned short *pusDest )
{
    ...
    if( pstrDecode == nullptr || *pstrDecode == nullptr || pusDest == nullptr)
    {
        return 0;
    }
...
int DecodeLong( char **pstrDecode, unsigned long *pulDest )
{
    ...
    if( pstrDecode == nullptr || *pstrDecode == nullptr || pulDest == nullptr)
    {
        return 0;
    }
...
{
    if( pstrEncode == nullptr || *pstrEncode == nullptr || pcSrc == nullptr || sMemSize <= 0 )
    {
        return 0;
    }
...
{
    if( pstrDecode == nullptr || *pstrDecode == nullptr || pcDest == nullptr || sMemSize <= 0 )
    {
        return 0;
    }
